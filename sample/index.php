		...
		<div class="carousel-inner" id = "home">
			<div class="row">
			  ...
			  <div class="header-hero-content carousel-caption d-md-block">
				<h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Travel Tours</h3>
		...
		<div class="row justify-content-center">
			<div class="col-lg-10">
				<div class="section-title text-center pb-40">
					...
					<h3 class="title">Travel Tours, <span> Comes with everything you need to get started!</span></h3>
				</div> <!-- section title -->
			</div>
		</div> <!-- row -->
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-7 col-sm-8">
				<div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
					<div class="services-icon">
						<img class="shape" src="./assets/img/" alt="Destination Img">
						<!-- <img class="shape-1" src="./assets/img/" alt="Destination Img"> -->
						<!-- <i class="lni-baloon"></i> -->
					</div>
					<div class="services-content mt-30">
						<h4 class="services-title"><a href="#">Boracay</a></h4>
			...
			<div class="col-lg-4 col-md-7 col-sm-8">
				<div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
					<div class="services-icon">
						<img class="shape" src="./assets/img/" alt="Destination Img2">
							<!-- <img class="shape-1" src="./assets/img/" alt="Destination Img2"> -->
						<!-- <i class="lni-cog"></i> -->
					</div>
					<div class="services-content mt-30">
						<h4 class="services-title"><a href="#">Palawan</a></h4>
						<p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod tempor invidunt labore.</p>
						<a class="more" href="#">Learn More <i class="lni-chevron-right"></i></a>
					</div>
				</div> <!-- single services -->
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
					<img src="./assets/img/" alt="Travel Tours-About me 3">
				</div> <!-- about image -->
			</div>
		</div> <!-- row -->
	</div> <!-- container -->
		...
		<div class="row">
			<div class="col-lg-6 order-lg-last">
				<div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
					<div class="section-title">
						<div class="line"></div>
						<h3 class="title">Travel Tours <span> with package included</span></h3>
					</div> <!-- section title -->
					<p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seiam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing.</p>
					<!-- <a href="#" class="main-btn">Try it Free</a> -->
				</div> <!-- about content -->
			...
			<div class="col-lg-6 order-lg-first">
				<div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
					<img src="./assets/img/" alt="Travel Tours-About me 2">
				</div> <!-- about image -->
			</div>
		</div> <!-- row -->
	</div> <!-- container -->
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
					<div class="section-title">
						<div class="line"></div>
						<h3 class="title"><span>Travel Tours</span> Leading the way in adventure</h3>
					</div> <!-- section title -->
					<p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seiam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing.</p>
...
<!--====== FOOTER PART START ======-->
<section id = "contactus" class = "contactus-area">
	<footer id="footer" class="footer-area pt-120" style="background-image: url(./assets/img/footer-bg.png)">
		<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-8">
						...
						<form>
							...
							<div class="form-outline mb-4">
								<input type="text" id="form4Example1" class="form-control" required placeholder = "Name"/>
							</div>

							<!-- Email input -->
							<div class="form-outline mb-4">
								<input type="email" id="form4Example2" class="form-control" required placeholder = "Email"/>
							</div>

							<!-- Message input -->
							<div class="form-outline mb-2">
								<textarea class="form-control" id="form4Example3" rows="4" required placeholder = "Message"></textarea>
							</div>

							<!-- Submit button -->
							<button type="submit" class="btn btn-primary btn-block mb-4" data-toggle="modal" data-target="#exampleModalCenter">Send</button>
							</form>
						</div> <!-- footer about -->
					</div>
					...
					<div class="col-lg-3 col-md-5 col-sm-5">
						<div class="footer-contact mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
							<a class="logo" href="#">
								<img src="./assets/logo/" alt="Travel Tours logo">
							</a>
							<ul class="contact">
								<li>+639123456789</li>
								<li>traveltours@gmail.com</li>
								<li>www.traveltours.com</li>
								<li>123 CLSU <br> Philippines.</li>
							</ul>
						</div> <!-- footer contact -->
					</div>
				</div> <!-- row -->
					...
					<div class="col-lg-12">
						<div class="copyright d-sm-flex justify-content-between">
							<div class="copyright-content">
								<p class="text">Designed and Developed by <a href="https://github.com/Terribityu" rel="nofollow">Terribtyu</a></p>
